        ...
        <div class="container">
            <div class="site-header-inner">
                <div class="brand header-brand">
                    <h1 class="m-0">
                        <a href="#">
                            <img class="header-logo-image asset-light" src="{{asset('landing/images/logo-light.svg')}}" alt="Logo">
                            <img class="header-logo-image asset-dark" src="{{asset('landing/images/logo-dark.svg')}}" alt="Logo">
                        </a>
                    </h1>
                </div>
            </div>
        ...
        <section class="hero">
            <div class="container">
                <div class="hero-inner">
                    <div class="hero-copy">
                        <h1 class="hero-title mt-0">Ecwa Media Center for Producers</h1>
                        <p class="hero-paragraph">Bless and serve lives with your inspired contents</p>
                        <div class="hero-cta">
                ...
                <div class="features-inner section-inner has-bottom-divider">
                    <div class="features-header text-center">
                        <div class="container-sm">
                            <h2 class="section-title mt-0">What we are about</h2>
                            <p class="section-paragraph">We believe we can bless lives by reaching out to this dying world with the gospel of Jesus.</p>
                        ...
                        <div class="feature is-revealing">
                            <div class="feature-inner">
                                <div class="feature-icon">
                                    ...
                                    <img class="asset-dark" src="{{asset('landing/images/feature-01-dark.svg')}}" alt="Feature 01">
                                </div>
                                <div class="feature-content">
                                    <h3 class="feature-title mt-0">Podcasts</h3>
                                    <p class="text-sm mb-0">Bless the Church of Christ with an amazing podcast</p>
                                </div>
                            </div>
                        </div>
                        <div class="feature is-revealing">
                            <div class="feature-inner">
                                <div class="feature-icon">
                                    ...
                                    <img class="asset-dark" src="{{asset('landing/images/feature-02-dark.svg')}}" alt="Feature 02">
                                </div>
                                <div class="feature-content">
                                    <h3 class="feature-title mt-0">Songs</h3>
                                    <p class="text-sm mb-0">Bless the Church with spirit inspired songs</p>
                                </div>
                            </div>
                        </div>
                        <div class="feature is-revealing">
                            <div class="feature-inner">
                                <div class="feature-icon">
                                    ...
                                    <img class="asset-dark" src="{{asset('landing/images/feature-03-dark.svg')}}" alt="Feature 03">
                                </div>
                                <div class="feature-content">
                                    <h3 class="feature-title mt-0">Prayers</h3>
                                    <p class="text-sm mb-0">Lead people to reach to God via prayer</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container-sm">
                <div class="cta-inner section-inner">
                    <div class="cta-header text-center">
                        <h2 class="section-title mt-0">Submit your God inspiring content and we shall air it for you</h2>
                        <p class="section-paragraph">Awesome, let's get started</p>
                        <div class="cta-cta">
            ...
            <div class="site-footer-inner">
                <div class="brand footer-brand">
                    <a href="#">
                        ...
                        <img class="asset-dark" src="{{asset('landing/images/logo-dark.svg')}}" alt="Logo">
                    </a>
                </div>
                ...
                <div class="footer-copyright">&copy; {{date('Y')}} Ilanaa, all rights reserved</div>
            </div>
        </div>
    </footer>
</div>
